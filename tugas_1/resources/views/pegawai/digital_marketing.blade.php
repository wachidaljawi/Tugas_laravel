...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top mb-5">
            <a class="navbar-brand ml-5" href="#"><img src="img/importir.png" class="img-fluid" alt=""
                ...
                <b style="color: black; line-height: 1.5; font-size: 25px;"><span><img src="/img/importir.jpg" alt="gambar" height="50px;"></span></b></a>
    ...
    <div class="container isi">
        <h2 class= "text-center">Digital Marketing Importir</h2>
